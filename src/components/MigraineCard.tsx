  ...
  return (
    <article className="relative flex gap-5 w-full rounded-xl border border-slate-200 bg-white px-6 py-5 shadow-sm transition hover:border-violet-300 hover:shadow-md">
      ...
      <div>
        <button
          type="button"
          className="absolute right-0 bottom-0 rounded-br-xl p-4 flex items-center justify-center bg-blue-100 hover:bg-blue-200 h-1/2 hover:cursor-pointer"
          onClick={onEdit}
        >
        ...
        <button
          type="button"
          className="absolute right-0 top-0 rounded-tr-xl p-4 flex items-center justify-center bg-purple-100 hover:bg-purple-200 h-1/2 hover:cursor-pointer"
          onClick={onDelete}
        >
